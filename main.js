 /* ROZ Bilisim ve Yazilim */
 *! Guvenis Etiket (ROZ DESiGN) - v4.3 - 2021-1-22
 *  Desc: ROZ Design - Bilisim - Yazılım - SEO ve İnternet Hizmetleri
 *  Requires: ROZ TASARIM.
 *  Copyright: (c) 2002-2021 ROZ Bilisim ve Yazilim - https://rozbilisim.tr.gg
 *  Dual licensed under the MIT (MIT-LICENSE.txt) 
 *  and GPL (GPL-LICENSE.txt) licenses.
 *  ROZ TASARIM (Gizlilik) ( https://rozbilisim.tr.gg/Gizlilik-Bildirimi.htm )
 *  Licensed under MIT (https://github.com/twbs/rozbilisim/master/LICENSE)
 *  Licensed under the MIT license - ( https://opensource.org/licenses/MIT )
 */
 * ================================================================ 
Bu telif hakki bildirimine hic bir zaman dokunulmamalidir. 
Patent Hakkı © 2002-2022 TPE-2019-06RCO-ROZ BiLiSiM ve YAZILIM 
Telif Hakki (c) 2021 ROZ BiLiSiM ve YAZILIM - rozbilisim.tr.gg - tum haklari saklidir.
=================================================================== */
/* https://roz-design.tr.gg */
/*
 * Bootstrap Medya 
 * Copyright 2021 ROZ BiLiSiM
 * Author(Yazar): ROZ TASARIM
 */
